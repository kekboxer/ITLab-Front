...
export const EQUIPMENT_TYPE_FETCH_ALL = 'EQUIPMENT_TYPE_FETCH_ALL';
export const EQUIPMENT_TYPE_FETCH_ONE = 'EQUIPMENT_TYPE_FETCH_ONE';
...
export const EQUIPMENT_TYPE_SET_ALL = 'EQUIPMENT_TYPE_SET_ALL';
export const EQUIPMENT_TYPE_SET_ONE = 'EQUIPMENT_TYPE_SET_ONE';
...
export const EQUIPMENT_TYPE_GET_ALL = 'EQUIPMENT_TYPE_GET_ALL';
export const EQUIPMENT_TYPE_GET_ONE = 'EQUIPMENT_TYPE_GET_ONE';
